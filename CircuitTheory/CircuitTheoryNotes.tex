...
\includegraphics[width=0.5\textwidth]{assets/11b7879b24f71ddbf3e5316424203201.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.5\textwidth]{assets/7d3f6db847882c6447cc046186ede6ef.jpg}
\includegraphics[width=0.5\textwidth]{assets/3f5d73ec5ae9909ab42cd864852b0d72.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.75\textwidth]{assets/1b9e0bed85e1f3a049de96f4c6018da8.jpg}
...
\item $A$ : 开环电压增益（open-loop voltage gain），在开环情况下\footnote{（无输入引回到输出）}满足 $u_o = Au_d = A(u_+-u_-) $，$A$ 因元件和温度而变，通常在 $10^5\sim 10^8$ 之间。
...
\begin{minipage}{0.31\textwidth}
    \begin{figure}[H]\centering
        \includegraphics[width=\textwidth]{assets/image (49).jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.7\textwidth]{assets/image (50).png}
...
\begin{figure}[H]\centering
\includegraphics[width=0.75\textwidth]{assets/image (51).png}
\caption{\textbf{负反馈 OPA 电路}}\label{负反馈 OPA 电路}
\end{figure}


\subsection{含负反馈的理想 OPA 电路}
...
对 IOPA 而言，始终有 $i_- = i_+ = 0$，称为两条支路分别“虚断”。由于本小节讨论的 IOPA 始终处于线性区，因此有 $u_+ - u_- = 0 \Longrightarrow u_+ = u_- $，称为两点“虚短”。
\end{definition}

\begin{center}\noindent\begin{minipage}{0.4\textwidth}
        \begin{figure}[H]\centering
            \includegraphics[height=100pt]{assets/4323bb51980c2d4d8e127dfa2e8110d0.png}
            \caption{\textbf{IOPA 输入输出曲线}}\label{IOPA 输入输出曲线}
        \end{figure}
    \end{minipage}\begin{minipage}{0.49\textwidth}
        \begin{figure}[H]\centering
            \includegraphics[height=100pt]{assets/电压跟随器.png}
...
\begin{subfigure}[t]{0.4\textwidth}\centering
    \includegraphics[height=100pt]{assets/同相比例放大器.png}
    \caption{\bfseries 同相比例放大器}
\end{subfigure}\begin{subfigure}[t]{0.4\textwidth}\centering
    \includegraphics[height=100pt]{assets/反向比例放大器.png}
...
\begin{subfigure}[t]{0.42\textwidth}\centering
    \includegraphics[height=100pt]{assets/反相加法器.png}
    \caption{\bfseries 反相加法器}
\end{subfigure}\begin{subfigure}[t]{0.4\textwidth}\centering
    \includegraphics[height=100pt]{assets/减法器.png}
