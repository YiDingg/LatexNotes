...
\chapter*{附录 A. 波理论}\addcontentsline{toc}{chapter}{附录 A. 波理论}\thispagestyle{fancy} \setcounter{section}{0}\renewcommand\thesection{A.\arabic{section}}
...
我们说图2.2中所示的脉冲和(2. 5) 式描述的扰动是一维的， 因为波扫过的是位于一条直线上的点－只需要一个空间变量来规定这些点在这个具体场合， 绳
索的上下振动是在第二个维度上的。与之相反， 一个二维波在一个面上传播， 像池塘上的皱
波， 它由两个空间变量描述。

\chapter*{附录 B}\addcontentsline{toc}{chapter}{附录 B}\thispagestyle{fancy} \setcounter{section}{0}
