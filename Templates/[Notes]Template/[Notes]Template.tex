...
% 附录 A
\chapter*{附录 A\hspace*{20pt}  某某课程 Q \& A}\addcontentsline{toc}{chapter}{附录 A\hspace*{6pt}  某某课程 Q \& A}   
\thispagestyle{fancy} 
...
% 附录 B
\chapter*{附录 B\hspace*{20pt}  中英文对照表}\addcontentsline{toc}{chapter}{附录 B\hspace*{6pt}  中英文对照表}   
\thispagestyle{fancy} 
\setcounter{section}{0}   
