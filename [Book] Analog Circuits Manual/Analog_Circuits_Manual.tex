...
% 页眉页脚设置
    \usepackage{fancyhdr}   % 宏包：页眉页脚设置
        ...
        \chead{Analog Circuits Manual}
        \rhead{\small dingyi233@mails.ucas.ac.cn}

%文档信息设置
    \title{Analog Circuits Manual\\ 模拟电路手册}
...
\subfile{contents/Chapter on Capacitance/Analog_Circuits_Manual (Capacitance).tex}
\subfile{contents/Chapter on Oscillators/Analog_Circuits_Manual (Oscillators).tex}
