...
非理想变压器等效：
\begin{figure}[H]\centering
    \includegraphics[width=\columnwidth]{assets/非理想变压器 2.pdf}
    \caption{非理想变压器的等效}
    \label{非理想变压器等效}
\end{figure}
\begin{figure}[H]\centering
    \includegraphics[width=\columnwidth]{assets/非理想变压器 2 copy.pdf}
\end{figure}
...
用单个功率表测对称电路的无功功率：
\begin{figure}[H]\centering
    \includegraphics[width=0.55\columnwidth]{assets/QQ_1735491515790.png}
\end{figure}
\begin{figure}[H]\centering
    \includegraphics[width=0.7\columnwidth]{assets/image copy 3.png}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.5\columnwidth}\centering
    \includegraphics[height=95pt]{assets/相电压线电压电流 - 副本 (2).pdf}
\end{subfigure}\hfill
\begin{subfigure}[b]{0.5\columnwidth}\centering
    \includegraphics[height=95pt]{assets/相电压线电压电流 - 副本.pdf}
\end{subfigure}
\end{figure}
...
\end{equation}
\begin{figure}[H]\centering
    \includegraphics[width=0.7\columnwidth]{assets/image copy.png}
\end{figure}
\begin{figure}[H]\centering
    \includegraphics[width=0.7\columnwidth]{assets/image copy 2.png}
\end{figure}

\item $RC$ 低通滤波器的波特图：
\begin{figure}[H]\centering
    \includegraphics[width=\columnwidth]{assets/波特图/RC 低通 波特图.pdf}
\end{figure} 
...
\item 识别变压器同名端：
\begin{figure}[H]\centering
    \includegraphics[width=\columnwidth]{assets/0a2707b2610d952a8f63f9bcfc51616f.png}
\end{figure}
