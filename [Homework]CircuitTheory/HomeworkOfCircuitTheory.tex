...
\begin{figure}[H]\centering
\includegraphics[width=0.65\textwidth]{assets/1/d3d69ecd6b1c1bc476fd4a4957fb9e56.png}
\end{figure}
...
\begin{figure}[H]\centering
\includegraphics[width=0.6\textwidth]{assets/1/9dda9e5f333b8cb7f498d15c015e5fd0.png}
\end{figure}
...
\begin{figure}[H]\centering
\includegraphics[width=0.35\textwidth]{assets/2/image (47).jpg}
\caption{\textbf{习题集 1-33}}
\end{figure}


\section{习题集 2-2}
对图 (a)，利用串并联和 $\Delta$-Y 变换，可以得到：
\begin{equation}
R = \frac{20\cdot\left( \frac{180}{13} + \frac{1}{2}(\frac{30}{13} + 10)\right)}{20 + \left( \frac{180}{13} + \frac{1}{2}(\frac{30}{13} + 10)\right)} = \frac{20\cdot \frac{240}{13}}{20 + \frac{240}{13}} = 9.6 \ \Omega
\end{equation}
对图 (b)，注意到六个电阻都分别与 a, b 两点相连，为并联关系，因此：
\begin{equation}
R_{ab} = \frac{1}{6}R 
\end{equation}
\begin{figure}[H]\centering
\includegraphics[width=0.5\textwidth]{assets/2/e02c39d3f229a4b6352b828e57c3737f.jpg}
...
\noindent\begin{minipage}{0.49\textwidth}
    \begin{figure}[H]\centering
        \includegraphics[width=\textwidth]{assets/2/bfc7d58924b9eaf9582656c984bd2c3b.jpg}
        \caption{\textbf{习题集 2-6}}
    \end{figure}
\end{minipage}\hfill
\begin{minipage}{0.45\textwidth}
    \begin{figure}[H]\centering
        \includegraphics[width=\textwidth]{assets/DrawioFiles/2-6.drawio.pdf}
...
\begin{figure}[H]\centering
\includegraphics[width=0.4\textwidth]{assets/2/78abd22edee32bbd38134d510246a9ab.jpg}
\caption{\textbf{习题集 2-8}}
\end{figure}

\section{习题集 2-11}

等效电路图如图 \ref{} 所示，可以先将两个并联的实践独立电压源等效为一个，由此计算通过 $4\ \Omega$ 电阻的电流。
\begin{equation}
U' = \frac{12\times 8 + 4\times 25}{4 + 8} = \frac{31}{3}\ \mathrm{V}, \quad R' = \frac{4\times 8}{4 + 8} = \frac{8}{3}\ \Omega \Longrightarrow I' = \frac{\frac{31}{3}}{\frac{8}{3}+4} = \frac{31}{20}\ \mathrm{A}
\end{equation}
再回到图 \ref{} 中，对右侧网格有电势差：
\begin{equation}
25 - 4I' - 8I = 0 \Longrightarrow I = 2.35 \ \mathrm{A}
\end{equation}
\begin{figure}[H]\centering
\includegraphics[width=0.5\textwidth]{assets/2/1187c3e12fa1e6bd8d2019d53bd2752a.jpg}
\caption{\textbf{习题集 2-11}}
\end{figure}

\section{习题集 2-17}

将左侧受控电流源等效为电压源，可以求得电流 $I$：
\begin{equation}
x
\end{equation}

\begin{figure}[H]\centering
\includegraphics[width=0.5\textwidth]{assets/2/78473b1c403974e048249bbdbf6a152f.jpg}
...
\begin{figure}[H]\centering
\includegraphics[width=0.5\textwidth]{assets/2/0c8d1f0fb90ef6983c0aef6451919e4b.jpg}
