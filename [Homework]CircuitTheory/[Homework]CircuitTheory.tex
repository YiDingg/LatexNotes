...
%\caption{ 第一次仿真作业 (2)}\label{第一次仿真作业 (2)}
%\end{figure}
...
由虚短和虚断，$i_4 = - \frac{u_s}{R_2} \Longrightarrow U_{ab} = -\frac{R_4}{R_2}u_s$，将电压源置零，可得戴维南等效电阻为 $R = R_4$，于是诺顿等效电流为 $i = \frac{U}{R} = - \frac{u_s}{R_2}$，也即大小 $\frac{u_s}{R_2}$，由 $a$ 指向 $b$，如图 \ref{6.6 讲义题 3-18 诺顿等效电路} 所示。并且电流之比：
\begin{equation}
...
\begin{figure}[H]\centering
\includegraphics[width=0.4\columnwidth]{assets/6/9d53a9b244bf76e6ad1734869043135a.png}
\caption{ 6.6 讲义题 3-18 诺顿等效电路}\label{6.6 讲义题 3-18 诺顿等效电路}
\end{figure}
