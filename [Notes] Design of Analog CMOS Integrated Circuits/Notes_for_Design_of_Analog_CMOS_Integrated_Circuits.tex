...
\subfile{contents/Chapter 5 Current Mirrors and Biasing/Notes for Razavi CMOS (Chapter 5).tex}
\subfile{contents/Chapter 9 Operational Amplifiers/Notes for Razavi CMOS (Chapter 9).tex}
\subfile{contents/Chapter 99 Design Sheets/Notes for Razavi CMOS (Chapter 99).tex}
