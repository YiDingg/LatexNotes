...
\begin{figure}[H]\centering
    \begin{subfigure}[b]{0.5\columnwidth}\centering
        \includegraphics[height=150pt]{assets/Transistors/2N7000 [onsemi (安森美)]/2N7000 正面.png}
        \caption{The front side}
    \end{subfigure}\hfill
    \begin{subfigure}[b]{0.5\columnwidth}\centering
        \includegraphics[height=150pt]{assets/Transistors/2N7000 [onsemi (安森美)]/2N7000 背面.png}
        \caption{The back side}
    \end{subfigure}
