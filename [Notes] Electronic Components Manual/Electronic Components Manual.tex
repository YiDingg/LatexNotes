...
\begin{figure}[H]\centering
    \includegraphics[width=0.82\columnwidth]{assets/Diodes/Intro/EComM_Diodes Symbols.pdf}
...
\end{minipage}\hfill\begin{minipage}{0.3\columnwidth}
    \begin{figure}[H]\centering
        \includegraphics[width=0.87\columnwidth]{assets/Diodes/Intro/image.png}
