...
\begin{figure}[H]\centering
    \includegraphics[width=0.73\columnwidth]{[Notes] Fundamentals of Microelectronics/assets/Chapter 2/pn depletion region.pdf}
\end{figure}
\vspace*{5mm}
\begin{figure}[H]\centering
    \begin{subfigure}[b]{0.25\columnwidth}\centering
        \includegraphics[height=95pt]{[Notes] Fundamentals of Microelectronics/assets/Chapter 10/(Page-509) MOS pair for OTA.pdf}
    \end{subfigure}
    \begin{subfigure}[b]{0.5\columnwidth}\centering
        \includegraphics[height=100pt]{[Notes] Fundamentals of Microelectronics/assets/Chapter 10/(Page-509) small-signal equivalent for MOS OTA.pdf}
    \end{subfigure}
\end{figure}
\vspace*{5mm}
\begin{figure}[H]\centering
    \includegraphics[width=0.75\columnwidth]{[Notes] Fundamentals of Microelectronics/assets/Chapter 6/(Page-27) Razavi CMOS (2nd edition, 2015).pdf}
\end{figure}
