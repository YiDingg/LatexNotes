...
电压比较器、正反馈 IOPA、滞回比较器等，详见教材 \cite[Page 66]{电路原理}。
...
{\color{red} 不含独立源}的二端口网络一定可以被等效，满足所需的参数矩阵相同即可。普遍的等效需要受控源，详见参考文献 \cite{电路原理} Page 79，这里不再赘述。特别地，若二端口满足互易条件，则可以等效为一个三电阻电路: 
\begin{equation}
\begin{matrix}
...
\begin{figure}[H]\centering
\includegraphics[width=0.55\textwidth]{assets/2/MOS管等效电路.png}
...
% 附录 B
\chapter*{附录 B. 电路原理 Q \& A}\addcontentsline{toc}{chapter}{附录 B. 电路原理 Q \& A}   
\thispagestyle{fancy} 
