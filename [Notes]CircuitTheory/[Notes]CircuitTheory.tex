...
% 序言
\begin{cnabstract}\normalsize 
本文为笔者本科时的“电路原理”课程笔记（Notes of Principles of Electric Circuits, 2024.8 - 2025.1）。读者可以在笔者的个人网站 \href{https://yidingg.github.io/YiDingg/\#/Notes/MajorCourses/CircuitTheoryNotes}{https://yidingg.github.io/YiDingg/\#/Notes/MajorCourses/CircuitTheoryNotes} 上找到课程信息、教材、教辅和作业答案等相关资料。
...
在分段线性法的指导下，我们可以提出二极管的几种近似模型。


\section{用 MOSFET 构成放大器}
