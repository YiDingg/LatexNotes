...
\begin{equation}
\boxed{
    u_o= \frac{1 + R_f \left( \frac{1}{R_m} + \frac{1}{R_3} + \frac{1}{R_4} \right)}{ \frac{1}{R_p} + \frac{1}{R_1} + \frac{1}{R_2}}\cdot \left( \frac{{\color{red} u_1}}{R_1} + \frac{{\color{red} u_2}}{R_2} \right) - R_f \cdot \left( \frac{{\color{red} u_3}}{R_3} + \frac{{\color{red} u_4}}{R_4} \right)
}
\end{equation}
...
\begin{figure}[H]\centering
    \includegraphics[width=0.4\columnwidth]{assets/6/Q factor.png}
...
\begin{figure}[H]\centering
    \begin{subfigure}[b]{0.5\columnwidth}\centering
        \includegraphics[height=80pt]{assets/6/[EComM] actual capacitor and inductor.pdf}
        \caption{实际电感模型}
    \end{subfigure}\hfill
    \begin{subfigure}[b]{0.5\columnwidth}\centering
        \includegraphics[height=80pt]{assets/6/[EComM] actual capacitor 2.pdf}
        \caption{实际电容模型}
    \end{subfigure}
    \caption{实际电感与实际电容}
    \label{实际电感与实际电容}
...
\begin{figure}[H]\centering
    \includegraphics[width=\columnwidth]{assets/6/L = 2mH, Rdc = 2 Ohm, C_p = 2 nF, R_ac = infty.pdf}
...
\begin{figure}[H]\centering
    \includegraphics[width=\columnwidth]{assets/6/C = 10 uF, L_esr = 2 nH, R_esr = 1 Ohm.pdf}
...
\end{equation}
\begin{figure}[H]\centering
    \includegraphics[width=0.5\columnwidth]{assets/6/互感/image.png}
    \caption{互感线圈}
    \label{互感线圈}
\end{figure}
对于正弦激励，可以写成相量形式：
...
\end{gather}
\begin{figure}[H]\centering
    \includegraphics[width=0.5\columnwidth]{assets/6/互感/image copy.png}
    \caption{电感去耦等效}
    \label{电感去耦等效}
\end{figure}
...
\end{equation}
\begin{figure}[H]\centering
    \includegraphics[width=0.9\columnwidth]{assets/6/互感/非理想变压器 2.pdf}
    \caption{非理想变压器的等效}
    \label{非理想变压器等效}
\end{figure}
...
\begin{figure}[H]\centering
    \includegraphics[width=0.25\columnwidth]{assets/6/三相电路/image.png}
    \caption{三相电路的线序}
\end{figure}
...
\begin{figure}[H]\centering
\begin{subfigure}[b]{0.5\columnwidth}\centering
    \includegraphics[height=90pt]{assets/6/三相电路/image copy.png}
    \caption{$\Delta$ 型负载}
\end{subfigure}\hfill
\begin{subfigure}[b]{0.5\columnwidth}\centering
    \includegraphics[height=100pt]{assets/6/三相电路/image copy 2.png}
    \caption{Y 型负载}
\end{subfigure}
\caption{对称负载三相电路}
\end{figure}
...
\begin{figure}[H]\centering
    \includegraphics[width=0.7\columnwidth]{assets/6/三相电路/image copy 5.png}
    \caption{两表法测三相电路功率}
\end{figure}
